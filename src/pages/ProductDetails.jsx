...
import { Button, Collapse, Row, Col, Card, Typography, Image, } from "antd";
...
const ProductDetails = () => {
  ...
  return (
    <>
      <div className="mx-auto px-6 py-12 mt-20">
            ...
            <Card className="p-6 rounded-lg">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-red-600 text-sm uppercase font-semibold"
                >
                  Size Chart
                </button>
                  {/* SizeChart Drawer */}
                <SizeChart isDrawerOpen={isDrawerOpen} setIsDrawerOpen={setIsDrawerOpen} /> 
              </div>
